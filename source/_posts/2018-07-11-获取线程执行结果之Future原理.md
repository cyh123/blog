...
由于在开发过程当中需要获取线程执行的结果，故使用到了Java并发工具包``java.util.concurrent``下的Future类，最终通过Future的get来获取到线程执行的结果。这里我们来简单解析下，Future的实现原理及使用方式。
...
欢迎关注个人公众号：
![个人公号](./2018-07-11-获取线程执行结果之Future原理/个人公号.jpg)
